...
<body>
    ...
    <div class="konten">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
                <h5 class="fw-bold text-center ">Laporan Data Absensi Siswa Per Mapel</h5>
                <br>
            </div>
            <div class="col-lg-12">
                <table width="50%">
            ...
            <div class="col-lg-12">
                ...
                <center>
                    ...
                    <p class="text-center">{!! QrCode::size(100)->generate(
                        url("/print_absen_mapel?id_mapel=$id_mapel&id_kelas=$id_kelas&tgl1=$tgl1&tgl2=$tgl2"),
                    ) !!}</p>
