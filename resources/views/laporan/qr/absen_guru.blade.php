...
<body>
    ...
    <div class="konten">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
                <h5 class="fw-bold text-center ">Laporan Data Absensi Guru</h5>
                <br>
            </div>
            <div class="col-lg-12">
                <table width="50%">
                    <thead>
                        ...
                        <tr>
                            <th width="45%">Jumlah Guru</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $guru->jml_guru }} Orang</td>
                        </tr>
                    </thead>
                </table>
            </div>
            <div class="col-lg-12">
                ...
                <center>
                    ...
                    <p class="text-center">{!! QrCode::size(100)->generate(url("/print_absen_guru?tgl1=$tgl1&tgl2=$tgl2")) !!}</p>
