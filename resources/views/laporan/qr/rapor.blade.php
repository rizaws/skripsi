        ...
        <div class="row justify-content-center">
                ...
                <table width="50%">
                    <thead>
                        <tr>
                            <th width="45%">NIS</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $siswa->nisn }}</td>
                        </tr>
                        <tr>
                            <th width="45%">Nama</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $siswa->nama }}</td>
                        </tr>
                        <tr>
                            <th width="45%">Kelas</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $siswa->kelas }}{{ $siswa->huruf }}</td>
                        </tr>
                        <tr>
                            <th width="45%">Wali Kelas</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $wali_kelas->nm_guru }}</td>
                        </tr>
                    </thead>
                </table>
            </div>
            <div class="col-lg-12">
                ...
                <center>
                    ...
                    <p class="text-center">{!! QrCode::size(100)->generate(url("/print_rapor?id_siswa=$id_siswa")) !!}</p>
