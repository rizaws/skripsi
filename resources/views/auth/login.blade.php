        ...
        <div class="container-login100">
            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="{{ route('login') }}" method="post">
                    <center>
                        <img src="https://ppdb.mtsn2kotabjm.sch.id/img/logo.png" alt="" width="80px">
                    </center>
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" id="username" class="block mt-1 w-full" type="text" name="username"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password is required">
                        <input class="input100" id="password" class="block mt-1 w-full" type="password" name="password"
                ...
                <div class="login100-more"
                    style="background-image: url(https://kalsel.kemenag.go.id/files/fotoberita/530618.jpg);">
                </div>
            </div>
        </div>
    </div>
