        ...
        <div class="row justify-content-center">
                ...
                <table width="50%">
                    <thead>
                        <tr>
                            ...
                            <th width="5%">:</th>
                            <td width="50%">{{ empty($nm_mapel->nm_mapel) ? 'ALL' : $nm_mapel->nm_mapel }}</td>
                        </tr>
                        <tr>
                            <th width="45%">Jumlah Guru</th>
                            <th width="5%">:</th>
                            <td width="50%">{{ $guru->jlh_guru }} Orang</td>
                        </tr>
                    </thead>
                </table>
            </div>
            <div class="col-lg-12">
                ...
                <center>
                    ...
                    <p class="text-center">{!! QrCode::size(100)->generate(url('/print_guru?id_mapel=' . $id_mapel)) !!}</p>
